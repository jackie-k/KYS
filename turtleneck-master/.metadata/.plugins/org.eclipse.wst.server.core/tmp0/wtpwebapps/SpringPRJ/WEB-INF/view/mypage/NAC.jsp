...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/logcheck.do">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
			<div style="font-size: 2rem; font-weight: bold;">이름 변경</div>
			<div class="col-sm-6 mb-3 mb-sm-0" style="margin-top: 45%;">새롭게 사용하실 이름을 입력해 주세요.</div>
			<div class="col-sm-6 mb-3 mb-sm-0" style="margin-top:25%;">
              <form method="POST" class="user" action="/Nacproc.do"onsubmit="return NC();">
               <div class="form-group row">
               <input type="text" class="form-control form-control-user" id="name" name="userName" placeholder="<%=userName %>">
               <input type="submit" class="btn btn-primary btn-user btn-block" value="이름 변경" style="margin-top: 7%;">          
			   </div>
              </form>
            </div>
