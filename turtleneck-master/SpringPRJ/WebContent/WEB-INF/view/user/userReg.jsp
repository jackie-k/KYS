          ...
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form id="userReg" action="/userRegProc.do" method="POST" class="user">
                ...
                <div class="form-group">
                <input type="hidden" class='alert alert-success' id="showreq" value="인증번호 요청" style="text-align: center;width:100%" >
                </div>
                <div class="form-group">
                	<input type="text" class="form-control form-control-user" id="ib" name="" placeholder="인증번호 6자리 입력">
                </div>
                <div class="form-group">
                	<input type="button" class="btn btn-primary btn-user btn-block" id="ic" value="인증번호 확인">
