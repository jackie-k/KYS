    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-1 text-gray-800"><%=userName %>님의 알림</h1>
          <p class="mb-4">회원님의 최근 알림입니다.</p>

          <!-- Content Row -->
          <div style="margin-right: -1.75rem; margin-left: -1.75rem; display: -webkit-box;">
            ...
            <div class="col-lg-6">
              ...
              <div class="card mb-4 py-3 border-left-primary">
                <div class="card-body">
                  <div class="small text-gray-500">December 12, 2019</div>
                    <span class="font-weight-bold">입출금내역관련내용......</span>
                </div>
              </div>
              ...
              <div class="card mb-4 py-3 border-left-success">
                <div class="card-body">
                  <div class="small text-gray-500">December 12, 2019</div>
                    <span class="font-weight-bold">가계부관련내용......</span>
                </div>
              </div>
              ...
              <div class="card mb-4 py-3 border-left-warning">
                <div class="card-body">
                  <div class="small text-gray-500">December 12, 2019</div>
                    <span class="font-weight-bold">챗봇관련내용....</span>
                </div>
              </div>
            </div>
          </div>
